...
trait DFTSigmaSPLExp extends DFTSigmaSPL_Base with SigmaSPLExp with InternalFunctionsExp {
  case class SPL_F2() extends SigmaSPLDef(2)
  def infix_SPL_F2(): Exp[SigmaSPLVector] = SPL_F2()
}

class DFTSigmaSPL extends DFTSigmaSPLExp
