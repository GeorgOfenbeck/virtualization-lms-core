...
class Core extends FilterHeader {
  ...
  def codeexport() = {
    ...
    val ini: StatFilterHeader = StatFilterHeader[Int, Int, Int, Int, Int, Int, Int, Int, Int](inlineInfo = inline, a = Some(0), b= Some(0))
