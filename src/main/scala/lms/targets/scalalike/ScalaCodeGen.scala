...
trait TupleHelper extends ScalaCodegen{
...
trait EmitHeadInternalFunctionAsClass extends ScalaCodegen with TupleHelper{
  self =>
...
trait EmitHeadNoTuples extends ScalaCodegen with TupleHelper{
  self =>
