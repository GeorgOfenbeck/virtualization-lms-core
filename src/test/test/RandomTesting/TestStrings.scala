...
object TestStrings extends RandomTester {
  ...
  class MRandomClass extends RandomClass
    ...
    with GenRandomStringOps
  {
    self =>
    override val codegen = new EmitHeadInternalFunctionAsClass with ScalaGenBooleanOps with ScalaGenPrimitivOps with ScalaGenStringOps {
